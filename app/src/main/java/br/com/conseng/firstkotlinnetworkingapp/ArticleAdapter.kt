...
class ArticleAdapter(private val mListItemClickListener: ListItemClickListener,
                     private val mArticleData: List<Article>) : RecyclerView.Adapter<ArticleAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        holder.mNewsTitleTV.text = mArticleData[position].title
    }
    ...
    inner class ArticleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        val mNewsTitleTV: TextView = itemView.findViewById(R.id.item_title) as TextView
